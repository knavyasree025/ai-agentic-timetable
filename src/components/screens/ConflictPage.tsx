            ...
            <div className="flex flex-col lg:flex-row gap-8">
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-4 mb-8">
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-xs text-slate-400">
                    <MapPin size={14} /> Room 101
                  </div>
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-xs text-slate-400">
                    <Clock size={14} /> Tuesday, 10:00 AM
                  </div>
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-lg border border-white/10 text-xs text-slate-400">
              ...
              <div className="lg:w-80 flex flex-col gap-4">
                <div className="p-6 rounded-3xl bg-blue-600/10 border border-blue-500/20">
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed mb-4">
                    Conflict Resolver Agent detected this clash during the validation phase. Moving to Room 102 is the most efficient solution with 95% satisfaction.
                  </p>
                ...
                <button className="w-full py-4 glass glass-hover rounded-2xl text-sm font-bold text-slate-300 hover:text-white transition-all mt-auto">
                  Ignore Conflict
                </button>
              </div>
            </div>
